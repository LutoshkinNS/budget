...
const from = './generated/@typespec/openapi3/openapi.json';
const components = './generated/components';
const to = './generated/ts-schemas';
...
try {
	for(const file of files){
		...
		await writeFile(`${to}/${name}.ts`, `const ${name} = ${JSON.stringify(parsedSchema, null, 2)} as const;\n\nexport default ${name};`) 
